from typing import Type, T, Dict, NamedTuple, List, Callable, Union
...
class ProcessingType(Enum):
    ...
    just_encode = ProcessingTypeProperties(dict_type=NamespaceDict, dicts=[NamespaceDict(), NamespaceDict()])
    pass_through = ProcessingTypeProperties(
        dict_type=PassThroughDict, dicts=[PassThroughDict(), PassThroughDict()]
    )
    ...
    @staticmethod
    def register_for(case: Union[Type[T], List[Type[T]]]) -> Callable:
        """
